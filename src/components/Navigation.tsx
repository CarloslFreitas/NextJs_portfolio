...
const Navigation = () => {
    ...
    return (
        <div style={{ maxWidth: "500px", }}
            className=" max-sm:bottom-[120px] relative z-[50] bottom-[70px] w-[80%] max-h-[150px] rounded-t-3xl flex justify-between items-center border bg-black bg-opacity-95 border-white px-4 py-7">
